    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <dl>
                ...
                <dt><b>Service Amount</b></dt>
                <dd class="pl-2"><?php echo number_format($service_amount, 2) ?></dd>
                <?php if ($attached_payment) : ?>
                    <dt><b>Attached Payment</b></dt>
                    <dd class="pl-2"> <img style="margin-right:auto;margin-left:auto;" src="../<?= $attached_payment ?>" width="250" height="250"></dd>
                <?php endif; ?>
            </dl>
        </div>
    </div>
