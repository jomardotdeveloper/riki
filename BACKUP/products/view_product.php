...
if (isset($_GET['id']) && $_GET['id'] > 0) {
    ...
    if ($qry->num_rows > 0) {
        ...
        $out = $conn->query("SELECT SUM(quantity) FROM order_items where product_id = '{$id}' and order_id in (SELECT id FROM order_list where `status` != 5) and is_origin=1")->fetch_array()[0];
        ...
        <div class="card card-outline rounded-0 card-primary shadow">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a class="btn btn-default border btn-sm btn-flat" href="javascript:void(0)" id="add_to_cart"><i class="fa fa-cart-plus"></i> Request Item</a>
                    <a class="btn btn-default border btn-sm btn-flat" href="javascript:void(0)" id="add_to_cart_other"><i class="fa fa-cart-plus"></i> Request To Other</a>
                </div>
            </div>
            <div class="card-body">
                <div class="container">
...
<script>
    $(function() {
        $("#add_to_cart_other").click(function() {
