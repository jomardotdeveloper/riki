      ...
      <?php if ($_settings->userdata('id') > 0 && $_settings->userdata('login_type') == 2) : ?>
        <div class="d-flex align-items-end">
          <div class="navbar-nav nav-item">
            ...
            ?>
            <a href="./?p=cart" class="nav-link"><span id="cart_count" class="badge badge-danger rounded-circle"><?= $cart_count ?></span> My Request Items</a>
          </div>
          <div class="navbar-nav nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="fa fa-user"></i> Hello, <?= $_settings->userdata('firstname') ?>
            </a>
