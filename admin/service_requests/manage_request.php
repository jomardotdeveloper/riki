        ...
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="service_amount" class="control-label">Service Amount</label>
                        <input type="text" name="service_amount" id="service_amount" class="form-control form-control-sm rounded-0" value="<?php echo isset($service_amount) ? $service_amount : "" ?>" required>
                    </div>
