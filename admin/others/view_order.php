...
<div class="card card-outline card-dark shadow rounded0-0">
    <div class="card-header">
        ...
        <div class="card-tools">
            ...
            <a class="btn btn-default btn-flat border btn-sm" href="./?page=others"><i class="fa fa-angle-left"></i> Back to List</a>
        </div>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="w-100" id="order-list">
                        ...
                        $total = 0;
                        if (isset($id)) :
                            $order_item = $conn->query("SELECT o.*,p.name, p.price, p.image_path,b.name as brand, cc.category FROM `order_items` o inner join product_list p on o.product_id = p.id inner join brand_list b on p.brand_id = b.id inner join categories cc on p.category_id = cc.id where o.order_id = '{$id}' and o.is_origin=0 order by p.name asc");
