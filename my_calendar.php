    ...
    $(document).ready(function() {
        var calendar = $('#calendar').fullCalendar({
            ...
            events: <?php
                    ...
                    $query = "SELECT * FROM service_requests INNER JOIN client_list ON service_requests.client_id=client_list.id WHERE service_requests.status = 1 AND client_id= $user_id";
