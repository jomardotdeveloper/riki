...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="" class="text-muted">Amount</label>
            <div class="ml-3"><b><?= isset($service_amount) ? number_format($service_amount, 2) : "N/A" ?></b></div>
        </div>
        <div class="col-md-6">
            <label for="" class="text-muted">Attach Payment</label>
            <?php if (!isset($attached_payment)) : ?>
                <div class="">
                    <form action="save_attachment.php" id="attachment_form" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-12">
            <center>
                <div><img style="margin-right:auto;margin-left:auto;" src="uploads/gcash.jpg" width="250" height="250"></div>
            </center>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12 text-right">
            ...
            <?php if (!isset($attached_payment)) : ?>
                <button class="btn btn-primary btn-flat btn-sm" type="button" id="attached_save_btn"><i class="fa fa-times"></i> Save</button>
            <?php endif; ?>
        </div>
    </div>
</div>
...
<script>
    $("#attached_save_btn").click(function() {
